...
//                throw new IllegalArgumentException("can not get javaBeanDeserializer. " + clazz.getName());
//            }
//
...
//            itemType = com.alibaba.fastjson.util.TypeUtils.getCollectionItemType(superClass);
//        }
//
//        if (itemType == null) {
