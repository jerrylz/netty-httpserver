...
//        long curTime = System.currentTimeMillis(); //用于根据maxAge计算Cookie的Expires
        ...
        if (httpServletRequest.getSession().isNew()) {
            String sessionCookieStr = com.abchina.core.constants.HttpConstants.JSESSION_ID_COOKIE + "=" + httpServletRequest.getRequestedSessionId() + "; path=/; domain=" + httpServletRequest.getServerName();
